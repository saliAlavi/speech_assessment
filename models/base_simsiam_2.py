...
class SimSiameseBasedModel(Model):
    ...
    def train_step(self, data):
        ...
        with tf.GradientTape() as tape:
            ...
            p_0, z_0 = self(audio_0_n, contrastive=True, training=True)
            p_1, z_1 = self(audio_1_n, contrastive=True, training=True)
    ...
    def SimSiameseLoss(p, z, m_p, m_z, threshold, lambda_):
        ...
        loss = 2*cond_p*tf.math.abs(m_diff)*projection-2*lambda_*cond_n*m_diff*projection
